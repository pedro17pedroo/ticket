/**
 * Property-Based Tests - Sections Email Validation
 * 
...
const sectionFormDataArb = fc.record({
...
describe('Sections Email Validation - Property-Based Tests', () => {
  /**
   * Property 9: Frontend Form Validation (Sections)
   * 
      ...
      fc.assert(
        fc.property(
          ...
          (formData) => {
            ...
            // If email is valid or empty, and required fields are provided, form should be valid
            if (formData.name && formData.name.trim() !== '' && formData.departmentId && formData.departmentId.trim() !== '') {
