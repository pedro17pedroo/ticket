    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          Instale o Desktop Agent nos computadores da sua organização para inventário automático, gestão de tickets e suporte remoto.
        </p>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-10">
        <h2 className="text-xl font-semibold mb-6 dark:text-white">Por que instalar o Desktop Agent?</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {agentInfo?.benefits?.map((benefit, index) => (
            <div key={index} className="flex flex-col items-center text-center p-4">
              <div className="mb-3">{getBenefitIcon(benefit.icon)}</div>
