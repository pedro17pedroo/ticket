...
const Modal = ({ isOpen, onClose, children }) => {
  ...
  return createPortal(
    <div className="fixed top-0 left-0 right-0 bottom-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[9999] p-4 sm:p-6 md:p-8 animate-in fade-in duration-200">
