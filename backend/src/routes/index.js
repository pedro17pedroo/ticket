...
// ==================== TICKETS ====================
router.get('/tickets', authenticate, requirePermission('tickets', 'read_all'), ticketController.getTickets);
router.get('/tickets/statistics', authenticate, requirePermission('tickets', 'read_all'), ticketController.getStatistics);
router.get('/tickets/:id', authenticate, requirePermission('tickets', 'read_all'), ticketController.getTicketById);
